...
<table id = "example" class="SectionTable display" >
    ...
    <tbody>
        ...
        <tr>
            <td><a href="https://github.com/LokeshSingh07/Data-Structures-and-Algorithms/blob/main/01%20Arrays/2_segregate_0s_and_1s.cpp">Segregate 0s and 1s</a></td>
        </tr>
        <tr>
            <td><a href="https://github.com/LokeshSingh07/Data-Structures-and-Algorithms/blob/main/01%20Arrays/3_find_unique_element.cpp">Find unique element</a></td>
        </tr>
        <tr>
